...
window.onbeforeunload = function () {
  ...
  const backgrounds = [
    'url("backgrounds/Moon flower (Unedited Version).jpg")',
    'url("backgrounds/Red moon desert.jpg")',
    'url("backgrounds/Wind.jpg")',
    'url("backgrounds/Vortec space.jpg")',
    'url("backgrounds/Tulips.jpg")',
    'url("backgrounds/Stonehenge (Getty Images Rescan).jpg")',
    'url("backgrounds/Follow.jpg")',
    'url("backgrounds/Azul.jpg")',
    'url("backgrounds/Autumn.jpg")',
    'url("backgrounds/Ascent.jpg")',
    'url("backgrounds/Azul.jpg")',
